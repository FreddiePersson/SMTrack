...
for outFrame = 1 : data.DETECT.stackSize
    ...
    if ~emptyFrame
        ...
        for ind = 1:numel(propFrame)
            coord = propFrame(ind).WeightedCentroid;
...
DETECT = struct('full_filename_raw', full_filename_raw, 'detectedPositions', {detPos}, 'timeBetweenFrames', num2str(data.DETECT.timeBetweenFrames), 'relIntTh', num2str(data.DETECT.relIntTh),...
