...
% Set name of window
set(hObject,'Name','SMT_Localize - Localize Detected Molecules: Fredrik Persson');
...
localizationHeight = displayHeight;
...
hLocPanel = uibuttongroup(...
    ...
    'Units','pixels',...
    'BackgroundColor',get(hObject,'Color'),...
    'Position',[x2 y1+delim panelWidth localizationHeight]);
...
hTrackingPanel = uibuttongroup(...
    ...
    'Units','pixels',...
    'BackgroundColor',get(hObject,'Color'),...
    'Position',[x2 y2+filtHeight+delim panelWidth filtHeight]);
...
uicontrol(...
    ...
    'String','Author: Fredrik Persson',...
    'FontName', 'Brush Script MT' ,...
    'ForegroundColor', [0.75 0.75 0.75],...
    'HorizontalAlignment', 'center',...
    'Position',[x2+20 y1+displayHeight/2-20 panelWidth-40 filtHeight/2-12]);
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[w-(3*bw+20) 10 1.5*bw bh],...
    'Callback',{@LoadButton});
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[w-(5*bw+20) 10 1.5*bw bh],...
...
%         'FontSize',varargin{end-1},...
%         'HorizontalAlignment','left',...
%         'String','Max Loc. Error [nm]: ',...
%         'FontName', varargin{end} ,...
%         'Position',[x1 y4 lw lh]);
%     uicontrol(...	% Value edit box
% 		'Parent',hObject,...
% 		'Style','edit',...
% 		'Tag','LOCALIZE_Locset_error_1',...
% 		'BackgroundColor',get(findobj('Tag','hSMT'),'Color'),...
% 		'Units','pixels',...
% 		'FontSize',varargin{end-1},...
% 		'TooltipString','Choose if localization errors based on Nature Methods 7, 377 - 381 (2010). Should be esimated and used to discriminate.',...
% 		'String','50',...
%         'FontName', varargin{end} ,...
% 	    'Callback',{},...
% 		'Position',[x2 y4+4 ew lh]);
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[x3 y12 lw lh],...
    'Callback',{@display2DButton},...
    'Tag','LOCALIZE_Locset_display2D_0',...
    'Enable','off');
...
uicontrol(...	% Checkbox
    ...
    'String','Overlay',...
    'FontName', varargin{end} ,...
    'Position',[x4 y12 lw lh],...
    'Callback',{},...
    'Tag','LOCALIZE_Locset_display2D_1',...
    'Value', 0,...
    'Enable','on');
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[x3 y13 lw lh],...
    'Callback',{@display3DButton},...
    'Tag','LOCALIZE_Locset_display3D_0',...
    'Enable','off');
...
uicontrol(...	% Checkbox
    ...
    'String','Show aligned',...
    'FontName', varargin{end} ,...
    'Position',[x4 y13 lw lh],...
    'Callback',{},...
    'Tag','LOCALIZE_Locset_align_1',...
    'Value', 0,...
    'Enable','on');
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[x3 y14 lw lh],...
    'Callback',{@alignButton},...
    'Tag','LOCALIZE_Locset_align_0',...
    'Enable','off');
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[x3 y15 lw lh],...
    'Callback',{@correctDriftButton},...
    'Tag','LOCALIZE_Locset_corrDrift_0',...
    'Enable','off');
uicontrol(...	% Value edit box
    'Parent',hObject,...
    'Style','edit',...
    'Tag','LOCALIZE_Locset_corrDrift_1',...
    'BackgroundColor',get(findobj('Tag','hSMT'),'Color'),...
    'Units','pixels',...
    'FontSize',varargin{end-1},...
    ...
    'FontName', varargin{end} ,...
    'Callback',{},...
    'Position',[x4 y15 ew lh],...
    'Visible', 'on');
uicontrol(...	% Title
    'Parent',hObject,...
    'Style','text',...
    'Tag','LOCALIZE_Locset_corrDrift_2',...
    'BackgroundColor',get(findobj('Tag','hSMT'),'Color'),...
    'Units','pixels',...
    'FontSize',varargin{end-1},...
    'HorizontalAlignment','left',...
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[x3 y16 lw lh],...
    'Callback',{@PALMPlotButton},...
    'Tag','LOCALIZE_Locset_PALMPlot_0',...
    'Enable','off');
uicontrol(...	% Value edit box
    'Parent',hObject,...
    'Style','edit',...
    'Tag','LOCALIZE_Locset_PALMPlot_1',...
    'BackgroundColor',get(findobj('Tag','hSMT'),'Color'),...
    'Units','pixels',...
    'FontSize',varargin{end-1},...
    ...
    'FontName', varargin{end} ,...
    'Callback',{},...
    'Position',[x4 y16 ew lh],...
    'Visible', 'on');
uicontrol(...	% Title
    'Parent',hObject,...
    'Style','text',...
    'Tag','LOCALIZE_Locset_PALMPlot_2',...
    'BackgroundColor',get(findobj('Tag','hSMT'),'Color'),...
    'Units','pixels',...
    'FontSize',varargin{end-1},...
    'HorizontalAlignment','left',...
...
uicontrol(...
    ...
    'FontName', varargin{end} ,...
    'FontSize',varargin{end-1},...
    'Position',[x3 y17 lw lh],...
    'Callback',{@revertButton},...
    'Tag','LOCALIZE_Locset_revert_0',...
    'Enable','on');
...
[filename, pathname] = uigetfile({'*.tif'; '*.stk'}, 'Select MetaMorph file', 'MultiSelect', 'on');
...
for calFile = 1:lastInd
    ...
    removeInd = [];
    newInd = 1;
    for ind2 = 1:length(newFileStruct)
        
        % Fit the frame
        newFile = double(newFileStruct(ind2).data);
        fit = robustGauss2DFit(newFile);
...
for posf = startVal:2:stopVal
    ...
    for i=1:length(row)
        ...
        % Get coordinaets for the fitting window
    ...
    set(findobj('Tag', 'LOCALIZE_Locset_display2D_0'), 'Enable', 'on');
    set(findobj('Tag', 'LOCALIZE_Locset_display3D_0'), 'Enable', 'on');
...
if get(findobj('Tag', 'LOCALIZE_Locset_display2D_1'), 'Value');
    ...
    if get(findobj('Tag', 'LOCALIZE_Locset_align_1'), 'Value');
        align(h2D);
    end
    title('XY Projection');
    rotate3d on;
...
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_0'), 'Enable', 'on');
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_1'), 'Visible', 'on');
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_2'), 'Visible', 'on');
set(findobj('Tag', 'LOCALIZE_Locset_PALMPlot_0'), 'Enable', 'on');
set(findobj('Tag', 'LOCALIZE_Locset_PALMPlot_1'), 'Visible', 'on');
set(findobj('Tag', 'LOCALIZE_Locset_PALMPlot_2'), 'Visible', 'on');
set(findobj('Tag', 'LOCALIZE_Locset_align_0'), 'Enable', 'on');
...
xCorr = x;
yCorr = y;
stepSize = str2double(get(findobj('Tag', 'LOCALIZE_Locset_corrDrift_1'), 'String'));
...
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_0'), 'Enable', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_1'), 'Visible', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_2'), 'Visible', 'off');
...
for l1ind = 1:length(sigmas)
    ...
    % Save residual, gackground, amplitude, x0, y0 & sigma for this run
...
set(findobj('Tag', 'LOCALIZE_Locset_display2D_0'), 'Enable', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_display3D_0'), 'Enable', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_0'), 'Enable', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_1'), 'Visible', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_corrDrift_2'), 'Visible', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_PALMPlot_0'), 'Enable', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_PALMPlot_1'), 'Visible', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_PALMPlot_2'), 'Visible', 'off');
set(findobj('Tag', 'LOCALIZE_Locset_align_0'), 'Enable', 'off');
